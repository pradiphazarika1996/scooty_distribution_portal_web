...
//             Digital Portal for Government Scooty Scheme
//           </h1>
//         </div>
...
//               to check your eligibility and
//             </span>{" "}
//             <br />
//             submit your application for the Government Scooty Scheme.
//           </h1>
//           <div className={styles.features}>
//             <div className={styles.featureItem}>
//               <CheckCircleFilled className={styles.featureIcon} />
//               <span className={styles.featureText}>Online Application</span>
//             </div>
//             <div className={styles.featureItem}>
//               <CheckCircleFilled className={styles.featureIcon} />
...
//             <div className={styles.featureItem}>
//               <CheckCircleFilled className={styles.featureIcon} />
//               <span className={styles.featureText}>Application Tracking</span>
//             </div>
//           </div>
//         </div>
//       </div>
